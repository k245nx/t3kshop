					...
					<section id="adaptivesection">
						<h3>Il mio account</h3>
							<div id=userAccountItem>
								<img style="float: left; clear: left; margin-right: 20px;"width="100" height="100" src="images/ordini.png" alt="ordini">
								<p style="color: #444444; font-size: 16px;">Ordini</p>
								<p style="color: #444444;">Visualizza gli ordini recenti</p>
								<form action="orders.jsp">
								    <input type="submit" value="I miei ordini">
								</form>
							</div>
							<div id=userAccountItem>
								<img style="float: left; clear: left; margin-right: 20px;"width="100" height="100" src="images/heart.png" alt="ordini">
								<p style="color: #444444; font-size: 16px;">Liste</p>
								<p style="color: #444444;">La tua lista dei desideri</p>
								<form action="wishlist.jsp">
								    <input type="submit" value="La mia lista desideri">
								</form>
							</div>
							<div id=userAccountItem>
								<img style="float: left; clear: left; margin-right: 20px;"width="100" height="100" src="images/impostazioni.png" alt="ordini">
								<p style="color: #444444; font-size: 16px;">Impostazioni</p>
								<p style="color: #444444;">Gestisci il tuo account</p>
								<form action="userAccount.jsp">
								    <input type="submit" value="Gestisci il tuo account">
								</form>
							</div>
							<br>
