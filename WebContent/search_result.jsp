						...
						<div id=internalsection2>
							<div id=internalsectionproducts>
								...
								<% for(int i=0; i<27 && i<results.getResultSearch().size(); i++){ %>
									<div id=product>
										<a href="<%="product?id=" + results.getResultSearch().get(i).getId() %>"><img id=productPic width="100" height="100" src="<%="images/products/" + (results.getResultSearch()).get(i).getImmagine()%>" alt="product"></a>
										<div id=productdescblock>
											<a href="<%="product?id=" + results.getResultSearch().get(i).getId() %>"><h5><%=(results.getResultSearch()).get(i).getNome()%></h5></a>
