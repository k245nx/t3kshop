			...
			<div id="centralblock">
				...
				<aside id="centrale">
					...
					<section id="adaptivesection">
						<h3>L'ordine è stato registrato correttamente.</h3>
						<p>Numero ordine: <%=request.getAttribute("idOrdine")%></p>
						<p><%=request.getAttribute("quantita")%> articoli saranno spediti a <%=request.getAttribute("nome")%> da t3k-shop.</p>
						<br>
						<a href="orders.jsp">Controlla i tuoi ordini</a>
					</section>
