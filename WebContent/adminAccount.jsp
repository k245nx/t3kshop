...
<jsp:useBean id="admin" class="model.Admin" scope="page" />
			...
			<div id="centralblock">
				...
				<aside id="centrale">
					...
					<section id="adaptivesection">
						...
						<%admin=manageAdmin.getAdmin(username);%>
						<form action="UpdateAdmin" method="post">
							...
							<div id=registerfields>
								<input id=registerfield type="text" name="adminUsername" value="<%=admin.getUsername()%>" readonly>
								<input id=registerfield type="text" name="adminNome" value="<%=admin.getNome()%>" readonly>
								<input id=registerfield type="text" name="adminCognome" value="<%=admin.getCognome()%>" readonly>
								<input id=registerfield type="password" name="adminPassword" value="<%=admin.getPassword()%>">
								<input id=registerfield type="text" name="adminEmail" value="<%=admin.getEmail()%>">
								<input id=registerfield type="text" name="adminTelefono" value="<%=admin.getTelefono()%>">
								<input type="hidden" name="adminUsername" value="<%=admin.getUsername()%>">
							</div>
							<div id=registerbuttons>
								<button id=registerbutton style="margin-top: 93px;" name="modificaPassword">Modifica</button>
								<button id=registerbutton name="modificaEmail">Modifica</button>
								<button id=registerbutton name="modificaTelefono">Modifica</button>
							</div>
						</form>
						<br>
